...
public class MainActivityTeac extends AppCompatActivity {
    ...
    void loginUser()
    {
        ...
        String unique=et3.getText().toString().trim();
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                Intent i = new Intent(MainActivityTeac.this, Wallhome.class);
                                i.putExtra("email", email);
                                startActivity(i);
                                MainActivityTeac.this.finish();

                            } else {
                                Toast.makeText(MainActivityTeac.this, "Invalid Username or Password", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
        }
        ...
        {
            et3.setError("Enter an ID");
            return;
        }
        else
        {
            et3.setError("Invalid ID");
            return;
        }
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(MainActivityTeac.this, MainActivity.class));
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder = new AlertDialog.Builder(MainActivityTeac.this,R.style.CustomDialogTheme);
